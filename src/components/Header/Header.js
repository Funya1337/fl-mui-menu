...
function Header(props) {
  ...
  const { history, menuState, openFirstMenu, closeMenus } = props;
  ...
  const open = menuState === MENU_STATE.FIRST_MENU_OPENED;
  console.log(1234, open);
  ...
  const handleToggleDrawer = () => {
    if (menuState === MENU_STATE.FIRST_MENU_OPENED) {
      closeMenus();
    } else {
      openFirstMenu();
    }
  ...
  return (
    <div className={classes.root}>
      ...
      >
        <Toolbar>
          <IconButton
            ...
            edge="start"
            style={{
              display: open || isDesktop ? "none" : "inherit",
              marginRight: 0
            }}
          >
      ...
      <Drawer
        ...
        variant="persistent"
        anchor="left"
        open={menuState === MENU_STATE.FIRST_MENU_OPENED}
        classes={{
